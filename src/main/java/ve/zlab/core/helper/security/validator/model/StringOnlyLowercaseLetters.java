...
public class StringOnlyLowercaseLetters extends KRule {
    
    private static final String PATTERN = "^[a-z]+$";

    public StringOnlyLowercaseLetters(final String message) {
        super(message, KRule.STRING_ONLY_LOWERCASE_LETTERS);
    }
